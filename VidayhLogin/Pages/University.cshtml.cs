...
namespace VidayhLogin.Pages
{
    public class UniversityModel : PageModel
    {
        ...
        public UniversityModel(IConfiguration config)
        {
            ...
            try
            {
                if (savemore == "LOGIN")
                {
                    ...
                    if (content.statuscode == (int)StatusCodesStatus.BadRequest)
                    {
                        ...
                        {
                            await Response.WriteAsync("<script language='javascript'>window.alert('Please Check Your Username');window.location='Index';</script>");
                    ...
                    {
                        await Response.WriteAsync("<script language='javascript'>window.alert('Something Went Wrong.');window.location='Index';</script>");
                ...
                else if (savemore == "Send Password")
                {
                    ...
                    //    //}
                    //}
                    await Response.WriteAsync("<script language='javascript'>window.alert('Currently We are unable to reset password.');window.location='university';</script>");
                    return Page();
                ...
                else if (savemore == "Change Password")
                {
                    ...
                    if (content.statuscode == (int)StatusCodesStatus.SuccessCode)
                    {
                        ...
                        await Response.WriteAsync("<script language='javascript'>window.alert('Password Changed Successfully');window.location='university';</script>");
                        return Page();
